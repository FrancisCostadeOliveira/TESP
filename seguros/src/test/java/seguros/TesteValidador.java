...
public class TesteValidador {
	...
	public void testeValidacaoFuncionarioOK() {
		...
		Date data = new Date();
		Funcionario o = new Funcionario(1L, "Joao Silva", "M", "07719687604", "(31)3340-2900", "(31)3340-2900",
				"(31)3340-2900", "teste@tese.com.br", data, data, null, null, "gilmar", "gilmarvagner", "gilmar123");
		System.out.println(o);
	...
	public void testeValidacaoFuncionarioErro() {
		Date data = new Date();
		Funcionario o = new Funcionario(1L, "Joao Silva", "C", "07719687604", "(31)3340-2900", "(31)3340-2900",
				"(31)3340-2900", "teste@tese.com.br", data, data, null, null, "gilmar", "gilmarvagner", "gilmar123");
		System.out.println(o);
		Set<ConstraintViolation<Funcionario>> constraintViolations = validator.validate(o);
		for (ConstraintViolation<Funcionario> c : constraintViolations) {
	...
	public void testeValidacaoSeguradoOK() {
		Date data = new Date();
		Segurado o = new Segurado(1L, "Ana Silvo", "M", "07719687604", "(31)3340-2900", "(31)3340-2900",
				"(31)3340-2900", "teste@tese.com.br", data, data, null, "A", "9916920309", "SSP", "1938300000", "A",
				data, data, "avenida silva", "310", "casa B", "35450-00", "vila velha", "Belo Horizonte", "MG", null);
	...
	public void testeValidacaoSeguradoErro() {
		Date data = new Date();
		Segurado o = new Segurado(1L, "Joao Silva", "99", "07719687604", "(31)3340-2900", "(31)3340-2900",
				"(31)3340-2900", "teste@tese.com.br", data, data, null, "B", "16920309", "SSP", "1010101010", "A", data,
				data, "avenida silva", "310", "casa B", "35450-00", "vila velha", "Belo Horizonte", "MG", null);
		System.out.println(o);
		Set<ConstraintViolation<Segurado>> constraintViolations = validator.validate(o);
		for (ConstraintViolation<Segurado> c : constraintViolations) {
			System.out.println(" Erro de Validacao: " + c.getMessage());
	...
	public void testeValidacaoPropostaOK() {
		...
		Proposta o = new Proposta(1L, data, "A", "zzzzzzzzz", new BigDecimal("90.00"), new BigDecimal("80.00"), data,
				data, 3, new BigDecimal("50.00"), 10, "brasil", "conta", "saldo", null, null, null, null, null);
		System.out.println(o);
	...
	public void testeValidacaoPropostaErro() {
		...
		Date data = new Date();
		Proposta o = new Proposta(1L, data, "9", "zzzzzzzzz", new BigDecimal("90.00"), new BigDecimal("80.00"), data,
				data, 3, new BigDecimal("50.00"), 10, "brasil", "conta", "saldo", null, null, null, null, null);
		System.out.println(o);
		Set<ConstraintViolation<Proposta>> constraintViolations = validator.validate(o);
		for (ConstraintViolation<Proposta> c : constraintViolations) {
	...
	public void testeValidacaoTramitacaoOK() {
		...
		Tramitacao o = new Tramitacao(1L, null, EtapaProcesso.APROVADA, new Date(20 - 01 - 2015),
				TipoDecisao.AUTOMATICA, null, null, null, null);
		System.out.println(o);
	...
	public void testeValidacaoVeiculoOK() {
		...
		Veiculo o = new Veiculo(1L, "VW", "gol", 2015, 2016, "PUT-3340", "abcdefghijklea", TipoCombustivel.GASOLINA,
				true, true, null);
		System.out.println(o);
	...
	public void testeValidacaoVeiculoErro() {
		...
		Veiculo o = new Veiculo(1L, "VW", "gol", 2016, 2016, "put-3340", "abcdefghijklea", TipoCombustivel.GASOLINA,
				true, true, null);
		System.out.println(o);
		Set<ConstraintViolation<Veiculo>> constraintViolations = validator.validate(o);
		for (ConstraintViolation<Veiculo> c : constraintViolations) {
